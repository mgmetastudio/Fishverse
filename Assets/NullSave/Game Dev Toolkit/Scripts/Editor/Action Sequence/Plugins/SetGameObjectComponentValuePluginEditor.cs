...
{
    [CustomUniversalPluginEditor(typeof(SetGameObjectComponentValuePlugin))]
    public class SetGameObjectComponentValuePluginEditor : UniversalPluginEditor
    {
