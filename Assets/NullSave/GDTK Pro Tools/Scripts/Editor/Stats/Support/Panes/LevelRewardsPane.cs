...
{
    public class LevelRewardsPane : TemplatePane
    {
        ...
        public override string Name { get { return "Level Rewards"; } }

        public override string Description { get { return "Rewards given to player for leveling up"; } }

        #endregion

        #region Constructors

        public LevelRewardsPane(SerializedObject obj, string fieldName, object inventoryDB) : base(obj, fieldName, inventoryDB)
        {
        ...
        {
            database.levelRewards.Insert(entryIndex, database.levelRewards[entryIndex].Clone());
        ...
        {
            List<UniversalPluginWrapper<AddOnPlugin>> addonList = database.levelRewards[entryIndex].addOnPlugins;
            ...
            GUILayout.Space(8);
            editor.DrawAddOnChoicePluginList(editing.FindPropertyRelative("pluginChoices"), database.levelRewards[entryIndex].pluginChoices, database, _addOnPlugins, inventoryDB);
