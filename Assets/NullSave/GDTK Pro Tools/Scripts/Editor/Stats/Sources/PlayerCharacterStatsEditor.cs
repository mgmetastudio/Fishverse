...
{
    [CustomEditor(typeof(PlayerCharacterStats))]
    public class PlayerCharacterStatsEditor : GDTKStatsEditor
    {
        ...
        private PlayerCharacterStats myTarget;
        ...
        private void OnEnable()
        {
            ...
            if (target is PlayerCharacterStats stats)
            {
                myTarget = stats;
            }
        }
        ...
        private void DesignTime(int displayFlags)
        {
            ...
            DesignTimeRaceAndClasses(displayFlags, (int)DisplayFlags.ClassAndRace, db, raceList, backgroundList, classList);

            DesignTimeStats(displayFlags, (int)DisplayFlags.Stats);

            DesignTimeLevel(displayFlags, (int)DisplayFlags.Leveling);
            ...
            DesignTimeUI(displayFlags, (int)DisplayFlags.UI);
        ...
        private void RunTime(int displayFlags)
        {
            ...
            RunTimeRaceAndClasses(displayFlags, (int)DisplayFlags.ClassAndRace, myTarget);
            ...
            RunTimeLevel(displayFlags, (int)DisplayFlags.Leveling, myTarget);
