...
{
    public class RaceUI : statsInfoUI
    {
        ...
        public GDTKRace race { get; private set; }
        ...
        private void Awake()
        {
            ...
            if (m_stats != null)
            {
                m_stats.onRaceChanged += UpdateUI;
                UpdateUI();
            }
        ...
        public void Load(GDTKRace race)
        {
            this.race = race;

            info = race != null ? race.info : null;
