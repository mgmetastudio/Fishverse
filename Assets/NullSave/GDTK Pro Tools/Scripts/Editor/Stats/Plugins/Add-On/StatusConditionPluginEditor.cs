...
{
    [CustomUniversalPluginEditor(typeof(StatusConditionPlugin))]
    public class StatusConditionPluginEditor : UniversalPluginEditor
    {
        ...
        {
            foreach (GDTKStatusCondition attrib in database.statusConditions)
            {
