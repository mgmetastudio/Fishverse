...
{
    public class ClassPane : TemplatePane
    {
        ...
        public override string Name { get { return "Classes"; } }

        public override string Description { get { return "Areas of discipline such as Mage or Figher"; } }

        #endregion

        #region Constructors

        public ClassPane(SerializedObject obj, string fieldName, object inventoryDB) : base(obj, fieldName, inventoryDB)
        {
        ...
        public override void EditEntry(GDTKStatsEditor editor, StatsDatabase database, ref int entryIndex, SerializedProperty editing)
        {
            ...
            editor.SimpleStringSearchProperty(editing.FindPropertyRelative("parentId"), "Parent Class Id", BuildClassIds);
            editor.SimpleProperty(editing, "playable");
            if (GDTKEditor.SimpleValue<bool>(editing, "playable"))
            {
        ...
        private void DrawTraits(SerializedProperty editing)
        {
            ...
            if (GUILayout.Button(new GUIContent("Add Trait", GDTKEditor.GetIcon("icons/add-small")), GUILayout.Height(24)))
            {
                ...
                database.classes[entryIndex].traits.Add(new GDTKTrait());
        ...
        {
            GDTKTrait trait = database.classes[entryIndex].traits[index];
