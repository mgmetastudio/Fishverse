...
{
    public class SearchabelStringPopupWindow : PopupWindowContent
    {
        ...
        public float width;
        public Action<List<string>> buildOptions;
        ...
        {
            onSelection?.Invoke(filteredObjs[selIndex]);
            editorWindow.Close();
        }
