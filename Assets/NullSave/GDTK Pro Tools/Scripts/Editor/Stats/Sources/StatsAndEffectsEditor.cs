...
{
    [CustomEditor(typeof(StatsAndEffects))]
    public class StatsAndEffectsEditor : GDTKStatsEditor
    {
        ...
        private StatsAndEffects myTarget;
        ...
        private void OnEnable()
        {
            ...
            if (target is StatsAndEffects effects)
            {
                myTarget = effects;
            }
        }
