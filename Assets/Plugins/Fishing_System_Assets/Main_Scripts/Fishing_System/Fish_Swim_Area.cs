...
public class Fish_Swim_Area : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider Player)
    {
        if(Fishing_Action_System != null)
        {
            ...
            {
                Fishing_Action_System.GetComponent<Fishing_Action_System>().isInFishSwimArea = true;
            }

            /*if (Player.tag == "Fishing_Float")
            {
                Fishing_Action_System.GetComponent<Fishing_Action_System>().canPlaceFloat = true;
            }*/
        }
    }
    ...
    void OnTriggerExit(Collider Player)
    {
        if (Fishing_Action_System != null)
        {
            Fishing_Action_System.GetComponent<Fishing_Action_System>().isInFishSwimArea = false;
