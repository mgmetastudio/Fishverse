...
Shader "Terrain Amplify Shader"
{
	Properties
	{
		...
		[ASEBegin]_TextureRotation("Texture Rotation", Float) = 0
		...
		[ASEEnd]_NormalStrength3("Normal Strength 3", Float) = 0.2
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord36 = IN.ase_texcoord8.xy * _Tiling_1 + float2( 0,0 );
				half3 unpack34 = UnpackNormalScale( tex2D( _Normal1, texCoord36 ), _NrmlStrength1 );
				unpack34.z = lerp( 1, unpack34.z, saturate(_NrmlStrength1) );
				half2 texCoord9 = IN.ase_texcoord8.xy * _Tiling2 + float2( 0,0 );
				half3 unpack19 = UnpackNormalScale( tex2D( _Normal2, texCoord9 ), _NormalStrength2 );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalStrength2) );
				half2 texCoord24 = IN.ase_texcoord8.xy * _TilingBase + _OffsetBase;
				float cos23 = cos( radians( _TextureRotation ) );
				float sin23 = sin( radians( _TextureRotation ) );
				half2 rotator23 = mul( texCoord24 - half2( 0.5,0.5 ) , float2x2( cos23 , -sin23 , sin23 , cos23 )) + half2( 0.5,0.5 );
				half temp_output_72_0 = saturate( ( pow( tex2D( _RMask1, rotator23 ).r , _PowerR ) * _MultiplyR ) );
				half3 lerpResult58 = lerp( unpack34 , unpack19 , temp_output_72_0);
				half2 texCoord45 = IN.ase_texcoord8.xy * _Tiling3 + float2( 0,0 );
				half3 unpack43 = UnpackNormalScale( tex2D( _Nrml3, texCoord45 ), _NormalStrength3 );
				unpack43.z = lerp( 1, unpack43.z, saturate(_NormalStrength3) );
				half temp_output_71_0 = saturate( ( pow( tex2D( _GMask2, rotator23 ).r , _PowerG ) * _MultiplyG ) );
				half3 lerpResult57 = lerp( lerpResult58 , unpack43 , temp_output_71_0);
	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				half2 texCoord36 = IN.ase_texcoord4.xy * _Tiling_1 + float2( 0,0 );
				half3 unpack34 = UnpackNormalScale( tex2D( _Normal1, texCoord36 ), _NrmlStrength1 );
				unpack34.z = lerp( 1, unpack34.z, saturate(_NrmlStrength1) );
				half2 texCoord9 = IN.ase_texcoord4.xy * _Tiling2 + float2( 0,0 );
				half3 unpack19 = UnpackNormalScale( tex2D( _Normal2, texCoord9 ), _NormalStrength2 );
				unpack19.z = lerp( 1, unpack19.z, saturate(_NormalStrength2) );
				half2 texCoord24 = IN.ase_texcoord4.xy * _TilingBase + _OffsetBase;
				float cos23 = cos( radians( _TextureRotation ) );
				float sin23 = sin( radians( _TextureRotation ) );
				half2 rotator23 = mul( texCoord24 - half2( 0.5,0.5 ) , float2x2( cos23 , -sin23 , sin23 , cos23 )) + half2( 0.5,0.5 );
				half temp_output_72_0 = saturate( ( pow( tex2D( _RMask1, rotator23 ).r , _PowerR ) * _MultiplyR ) );
				half3 lerpResult58 = lerp( unpack34 , unpack19 , temp_output_72_0);
				half2 texCoord45 = IN.ase_texcoord4.xy * _Tiling3 + float2( 0,0 );
				half3 unpack43 = UnpackNormalScale( tex2D( _Nrml3, texCoord45 ), _NormalStrength3 );
				unpack43.z = lerp( 1, unpack43.z, saturate(_NormalStrength3) );
				half temp_output_71_0 = saturate( ( pow( tex2D( _GMask2, rotator23 ).r , _PowerG ) * _MultiplyG ) );
				half3 lerpResult57 = lerp( lerpResult58 , unpack43 , temp_output_71_0);
...
/*ASEBEGIN
Version=19106
Node;AmplifyShaderEditor.Vector2Node;29;-2424.505,-1465.493;Inherit;False;Property;_OffsetBase;Offset Base;13;0;Create;True;0;0;0;False;0;False;0,0;1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-2358.857,-1225.065;Inherit;False;Property;_TextureRotation;Texture Rotation;1;0;Create;True;0;0;0;False;0;False;0;180;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-1400.822,-1031.372;Inherit;False;Property;_PowerR;Power R;7;0;Create;True;0;0;0;False;0;False;0.5294116;0.651;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;35;-1918.265,-243.9433;Inherit;False;Property;_Tiling_1;Tiling_1;15;0;Create;True;0;0;0;False;0;False;0,0;50,50;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;14;-1914.412,114.7882;Inherit;False;Property;_Tiling2;Tiling 2;19;0;Create;True;0;0;0;False;0;False;0,0;30,30;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PowerNode;80;-1100.195,-1063.588;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-1634.492,-571.721;Inherit;False;Property;_PowerG;Power G;10;0;Create;True;0;0;0;False;0;False;1.070588;1.301;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-1139.605,-802.883;Inherit;False;Property;_MultiplyR;Multiply R;8;0;Create;True;0;0;0;False;0;False;0;2.5;0;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;44;-1918.071,540.1602;Inherit;False;Property;_Tiling3;Tiling 3;23;0;Create;True;0;0;0;False;0;False;0,0;20,20;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;83;-1524.93,-486.4244;Inherit;False;Property;_MultiplyG;Multiply G;11;0;Create;True;0;0;0;False;0;False;0;2.3;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1284.172,-1342.725;Inherit;False;Property;_Blendamount;Blend amount;2;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-1409.466,-1534.982;Inherit;True;Property;_Basetexture;Base texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-1666.673,-47.48434;Inherit;False;Property;_NrmlStrength1;NrmlStrength 1;17;0;Create;True;0;0;0;False;0;False;0.2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1662.82,311.2471;Inherit;False;Property;_NormalStrength2;Normal Strength 2;21;0;Create;True;0;0;0;False;0;False;0.2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;94;261.1212,-665.1716;Inherit;False;Property;_Hue;Hue;3;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;92;271.1212,-498.1716;Inherit;False;Property;_Value;Value;5;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;90;262.0351,-573.2308;Inherit;False;Property;_Saturation;Saturation;4;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-1652.279,712.6124;Inherit;False;Property;_NormalStrength3;Normal Strength 3;25;0;Create;True;0;0;0;False;0;False;0.2;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;95;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;96;899.1347,-636.3785;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Terrain Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;True;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;97;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;98;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;99;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;100;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;101;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;102;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;103;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;104;899.1347,-636.3785;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=EF346C484F681266BE466B1B92F4EF237997CE5E