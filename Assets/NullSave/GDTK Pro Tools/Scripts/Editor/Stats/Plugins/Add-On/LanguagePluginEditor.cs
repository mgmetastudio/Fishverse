...
//{
//    [CustomUniversalPluginEditor(typeof(LanguagePlugin))]
//    public class LanguagePluginEditor : UniversalPluginEditor
//    {
...
//        {
//            foreach (GDTKLanguage attrib in database.languages)
//            {
