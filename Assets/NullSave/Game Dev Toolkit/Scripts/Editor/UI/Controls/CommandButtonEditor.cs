...
namespace NullSave.GDTK
{
    ...
    public class CommandButtonEditor : GDTKEditor
    {
        ...
        {
            if (target is CommandButton button)
            {
                myTarget = button;
            }
        ...
        public override void OnInspectorGUI()
        {
            ...
            SectionHeader("Text");
            SimpleProperty("target", "TMPro UGUI");
