...
{
    public class RacePane : TemplatePane
    {
        ...
        public override string Name { get { return "Races"; } }

        public override string Description { get { return "Biology can grant its own boons and flaws"; } }

        #endregion

        #region Constructors

        public RacePane(SerializedObject obj, string fieldName, object inventoryDB) : base(obj, fieldName, inventoryDB)
        {
        ...
        public override void EditEntry(GDTKStatsEditor editor, StatsDatabase database, ref int entryIndex, SerializedProperty editing)
        {
            ...
            editor.SimpleStringSearchProperty(editing.FindPropertyRelative("parentId"), "Parent Race Id", BuildRaceIds);
        ...
        private void DrawTraits(SerializedProperty editing)
        {
            ...
            if (GUILayout.Button(new GUIContent("Add Trait", GDTKEditor.GetIcon("icons/add-small")), GUILayout.Height(24)))
            {
                ...
                database.races[entryIndex].traits.Add(new GDTKTrait());
        ...
        {
            GDTKTrait trait = database.races[entryIndex].traits[index];
